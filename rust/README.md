...
| `QMP_MCP_QEMU_BINARY` | `qemu-system-x86_64` | which emulator to launch — set `qemu-system-aarch64` for ARM guests, etc. (the spec's `machine`/`cpu` still shape the argv) |
